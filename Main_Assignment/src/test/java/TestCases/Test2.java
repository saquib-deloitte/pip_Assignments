...
public class Test2 {
    ...
    public void TestBegin() {
        ...
        details = FetchData.getTestData();

        fName = details.get(1).get(0);
        lName = details.get(1).get(1);
        postalCode = details.get(1).get(2);
    }
    ...
    void User2() {
        ...
        Assert.assertEquals(Integer.toString(amount), userAccount.getAmount());
        ...
        Assert.assertTrue(withdraw.enterAmount(200));
        amount -= 200;

        trscn.add(Integer.toString(-200));
